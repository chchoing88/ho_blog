...
파일 지원에 대한 또 하나의 참고 사항은 JSON을 가져올 수 있으며 사용할 자바스크립트 객체로 변환된다. 그러나 실제로 애플리케이션을 빌드할 때 [Rollup JSON 플러그인](https://github.com/rollup/plugins/tree/master/packages/json)이 필요하다.
