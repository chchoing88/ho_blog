...
* then을 수행시 마다 새로운 스코프 환경이 생긴다. then을 수행한다는 것은 자신의 스코프에 등록되어 있는 함수를 수행완료 시키고 나서 다음으로 호출되어야 하는 함수를 등록해줄 뿐만 아니라, 그 등록된 함수가 수행이 완료되고 나서의 또 다른 함수 호출을 보장하기 then의 실행 구문을 Promise로 감싸주고 리턴해준다.
